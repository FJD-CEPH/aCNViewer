...
* a recent version of R with [ggplot2](https://cran.r-project.org/web/packages/ggplot2/index.html) installed for generating the different graphical outputs:
  ...
  + [Sequenza](https://cran.r-project.org/web/packages/sequenza/index.html) and [samtools](wget -O samtools.tar.bz2 https://sourceforge.net/projects/samtools/files/latest/download?source=files) if you are analyzing paired (tumor / normal) bams
